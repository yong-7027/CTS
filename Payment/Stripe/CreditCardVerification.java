...
//
//public class CreditCardVerification extends Payment {
...
//    }
//
//    public CreditCardVerification(String cardNo, String expiredDate, String cvc, String email) {
//        this.cardNo = cardNo;
...
//
//        do {
//            CreditCard card = initializeCreditCard();
//            paymentMethod = createPaymentMethod(card);
//            customer = createCustomer(card);
//        } while (paymentMethod == null || customer == null);
//
...
//    }
//
//    private PaymentMethod createPaymentMethod(CreditCard card) {
//        try {
...
//                            .setExpMonth((long) getExpiredMonth(card.getExpiredDate()))
//                            .setExpYear((long) getExpiredYear(card.getExpiredDate()))
//                            .setCvc(card.getCvc())
//                            .build())
//                    .build();
//
...
//    }
//
//    private Customer createCustomer(CreditCard card) {
//        try {
